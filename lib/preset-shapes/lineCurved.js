...
module.exports = (function(){
  ...
  function getPathSegments(data) {
    ...
    if (!!markerStart && firstPoint.anchor && typeof(firstPoint.anchor[2]) !== 'undefined' && typeof(firstPoint.anchor[3]) !== 'undefined') {
      ...
      var firstOffset;
      var firstMarkerData = crossPlatformShapes.presetShapes[markerStart].getDimensions();
      if (!!firstMarkerData) {
    ...
    if (!!markerEnd && lastPoint.anchor && typeof(lastPoint.anchor[2]) !== 'undefined' && typeof(lastPoint.anchor[3]) !== 'undefined') {
      ...
      var lastOffset;
      var lastMarkerData = crossPlatformShapes.presetShapes[markerEnd].getDimensions();
      if (!!lastMarkerData) {
