module.exports = function(data){
  ...
  var outerRoundedRectangle = crossPlatformShapes.presetShapes.roundedRectangle(data);
  ...
  var innerRoundedRectangle = crossPlatformShapes.presetShapes.roundedRectangle(innerRoundedRectangleData);
