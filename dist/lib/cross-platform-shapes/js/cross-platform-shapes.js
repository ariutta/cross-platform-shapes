...
},{"./lib/cross-platform-shapes":3}],2:[function(require,module,exports){
module.exports = {};
...
},{"./canvas/canvas":2,"./custom-shapes":4,"./preset-shapes/preset-shapes":35,"./svg/svg":45,"lodash":46}],4:[function(require,module,exports){
module.exports = {
  arc: {
...
module.exports = (function(){
  ...
  function getPathSegments(crossPlatformShapesInstance, data) {
    var x = data.x,
      ...
      width = data.width,
      height = data.height;
    var outerEllipse = crossPlatformShapesInstance.presetShapes.ellips.getPathSegmentse(crossPlatformShapesInstance, data);
    /*
...
},{"./arc":5,"./arrow":6,"./brace":7,"./complex":8,"./ellipse":9,"./ellipseDouble":10,"./endoplasmicReticulum":11,"./golgiApparatus":12,"./hexagon":13,"./lineCatmullRom":14,"./lineCurved":15,"./lineElbow":16,"./lineSegmented":17,"./lineStraight":18,"./mimBinding":19,"./mimBranchingLeft":20,"./mimBranchingRight":21,"./mimCatalysis":22,"./mimCleavage":23,"./mimConversion":24,"./mimCovalentBond":25,"./mimDegradation":26,"./mimGap":27,"./mimInhibition":28,"./mimModification":29,"./mimNecessaryStimulation":30,"./mimStimulation":31,"./mimTranscriptionTranslation":32,"./mitochondria":33,"./pentagon":34,"./rectangle":36,"./roundedRectangle":37,"./roundedRectangleDouble":38,"./sarcoplasmicReticulum":39,"./tBar":40,"./triangle":41}],36:[function(require,module,exports){
module.exports = (function(){
  'use strict';
...
},{"./image":42,"./marker":43,"./path":44}],46:[function(require,module,exports){
(function (global){
/**
 * @license
